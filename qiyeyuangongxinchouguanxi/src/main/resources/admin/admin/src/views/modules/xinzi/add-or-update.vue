        ...
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               ...
               <el-col :span="12" v-if="type == 'info'">
                   <el-form-item class="input" v-if="type!='info'"  label="应发" prop="yingfaJine">
                       <el-input v-model="ruleForm.yingfaJine"
                                 placeholder="应发" clearable  :readonly="ro.yingfaJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="应发" prop="yingfaJine">
                           <el-input v-model="ruleForm.yingfaJine"
                                     placeholder="应发" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12" v-if="type == 'info'">
                   <el-form-item class="input" v-if="type!='info'"  label="代扣失业金" prop="daikouShiyejinJine">
                       <el-input v-model="ruleForm.daikouShiyejinJine"
                                 placeholder="代扣失业金" clearable  :readonly="ro.daikouShiyejinJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="代扣失业金" prop="daikouShiyejinJine">
                           <el-input v-model="ruleForm.daikouShiyejinJine"
                                     placeholder="代扣失业金" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12" v-if="type == 'info'">
                   <el-form-item class="input" v-if="type!='info'"  label="代扣养老保险金" prop="daikouYanglaojinJine">
                       <el-input v-model="ruleForm.daikouYanglaojinJine"
                                 placeholder="代扣养老保险金" clearable  :readonly="ro.daikouYanglaojinJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="代扣养老保险金" prop="daikouYanglaojinJine">
                           <el-input v-model="ruleForm.daikouYanglaojinJine"
                                     placeholder="代扣养老保险金" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12" v-if="type == 'info'">
                   <el-form-item class="input" v-if="type!='info'"  label="代扣公积金" prop="daikouGongjijinJine">
                       <el-input v-model="ruleForm.daikouGongjijinJine"
                                 placeholder="代扣公积金" clearable  :readonly="ro.daikouGongjijinJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="代扣公积金" prop="daikouGongjijinJine">
                           <el-input v-model="ruleForm.daikouGongjijinJine"
                                     placeholder="代扣公积金" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12" v-if="type == 'info'">
                   <el-form-item class="input" v-if="type!='info'"  label="代扣个人所得税" prop="daikouGerensuodeshuiJine">
                       <el-input v-model="ruleForm.daikouGerensuodeshuiJine"
                                 placeholder="代扣个人所得税" clearable  :readonly="ro.daikouGerensuodeshuiJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="代扣个人所得税" prop="daikouGerensuodeshuiJine">
                           <el-input v-model="ruleForm.daikouGerensuodeshuiJine"
                                     placeholder="代扣个人所得税" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12" v-if="type == 'info'">
                   <el-form-item class="input" v-if="type!='info'"  label="实发工资" prop="shifaJine">
                       <el-input v-model="ruleForm.shifaJine"
                                 placeholder="实发工资" clearable  :readonly="ro.shifaJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实发工资" prop="shifaJine">
                           <el-input v-model="ruleForm.shifaJine"
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    butieJine: false,
                    yingfaJine: false,
                    daikouShiyejinJine: false,
                    daikouYanglaojinJine: false,
                    daikouGongjijinJine: false,
                    daikouGerensuodeshuiJine: false,
                    shifaJine: false,
                    xinziContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    ...
                    yingfaJine: '',
                    daikouShiyejinJine: '',
                    daikouYanglaojinJine: '',
                    daikouGongjijinJine: '',
                    daikouGerensuodeshuiJine: '',
                    shifaJine: '',
                    xinziContent: '',
                    insertTime: '',
                },
                ...
                rules: {
                   ...
                   yingfaJine: [
                              { required: true, message: '应发不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   daikouShiyejinJine: [
                              { required: true, message: '代扣失业金不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   daikouYanglaojinJine: [
                              { required: true, message: '代扣养老保险金不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   daikouGongjijinJine: [
                              { required: true, message: '代扣公积金不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   daikouGerensuodeshuiJine: [
                              { required: true, message: '代扣个人所得税不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
