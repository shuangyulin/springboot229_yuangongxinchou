...
public class XinziEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Xinzi{" +
            ...
            ", daikouShiyejinJine=" + daikouShiyejinJine +
            ", daikouYanglaojinJine=" + daikouYanglaojinJine +
            ", daikouGongjijinJine=" + daikouGongjijinJine +
            ", daikouGerensuodeshuiJine=" + daikouGerensuodeshuiJine +
            ", shifaJine=" + shifaJine +
